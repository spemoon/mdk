define(function(require, exports, module) {
    ...
    var config = {
        ...
        prevent_swf_caching: false, // 该布尔值设置是否在Flash URL后添加一个随机值，用来防止浏览器缓存了该SWF影片。这是为了解决一些基于IE-engine的浏览器上的出现一个BUG
    ...
    var upload = function(params) {
        ...
        settings.file_queue_error_handler = function(file, code, message) {
            if(code == SWFUpload.QUEUE_ERROR.QUEUE_LIMIT_EXCEEDED) {
                ...
                (file && params.errorAdd) && params.errorAdd.call(_this, file, code, message);
            }
        };
